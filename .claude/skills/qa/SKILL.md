...
Read the governing entries from the following index when relevant to the changed behavior:
...
Select checks for the changed surfaces and complete any required phase/release gates. Reuse passing
results for unchanged code and environment; rerun affected checks after fixes. Available commands:
