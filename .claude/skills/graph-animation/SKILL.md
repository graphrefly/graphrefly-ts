...
- **No `setTimeout`, no `requestAnimationFrame`** — everything goes through the GSAP timeline (HyperFrames seeking requirement, also project invariant from CLAUDE.md "no raw async primitives").
