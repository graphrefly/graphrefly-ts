...
const GENERATION_REF = "current-graph-native-provider-boundary-2026-08-21-d55-v9" as const;
...
const directory = resolve(
	process.argv[2] ??
		join(
			import.meta.dirname,
			"../.private/empirical-memory-rerun-avoidance/current-graph-native-d55-qualified-v9",
		),
);
