...
import type { D773LiveRouteEvidenceV1 } from "./d773-live-route-authority.js";

export const D773_ARM_AWARE_GATE_PROJECTION_REVISION =
	"graphrefly.b112.d773.arm-aware-positive-gate-projection.v1" as const;
...
export interface D773ArmAwarePositiveGateV1 {
	readonly projectionRevision: typeof D773_ARM_AWARE_GATE_PROJECTION_REVISION;
...
export function evaluateD773ArmAwarePositiveGate(
	graph: D771CanonicalGraphEvidenceV1,
	routeEvidence: D773LiveRouteEvidenceV1,
	expectedSourceDigest: string,
): D773ArmAwarePositiveGateV1 {
	...
	const exposureBound = (arm: (typeof ARMS)[number], fact: AdmittedFact) => {
		...
		return routeFact !== undefined && routeFact.arm === arm;
	};
	if (
	...
	const material = strictSnapshot({
		projectionRevision: D773_ARM_AWARE_GATE_PROJECTION_REVISION,
