...
export const D738_DISPATCH_CLAIM_SCHEMA =
	"graphrefly.b112.d741.single-use-dispatch-claim.v1" as const;
...
export interface D738ExecutionAuthorityV1 {
	readonly revision: "graphrefly.b112.d741.execution-authority.v1";
...
export async function consumeD738DispatchClaimForExecution(inputValue: {
	...
	const authority = Object.freeze({
		revision: "graphrefly.b112.d741.execution-authority.v1" as const,
		claim,
