...
export const D753_DECISION_REF = "decision.D753" as const;
export const D753_DECISION_REVISION = "2026-08-12.v1" as const;
export const D753_GENERATION_REF = "d753-graph-transport-diagnostic-live-2026-08-12-v1" as const;
export const D753_DISPATCH_CLAIM_REF =
	"d753-graph-transport-diagnostic-dispatch-2026-08-12-v1" as const;
export const D753_HISTORICAL_ARTIFACT_SHA256 =
	"sha256:478a4299a28fc907914e44802450af3dbbe7726aadf4a063730b1b3416e4c3bb" as const;
export const D753_HISTORICAL_BUNDLE_DIGEST =
	"sha256:c4e9673dd5ef69abb89e1d3b0f8379817d02e2f5db0d2458b5b3907fa95d14b7" as const;
export const D753_HISTORICAL_GENERATION_DIGEST =
	"sha256:558c853737b2412b30876093e01e4db0a9ffce105a02a73ac1c191a2195bd692" as const;
export const D753_HISTORICAL_QUALIFICATION_DIGEST =
	"sha256:a59d1b9b7c864d2522b66692489d7234c9eeb764dd3b8966078108871ec3e28b" as const;
export const D753_BASELINE_COMMIT = "12569797" as const;
export const D753_D737_PHASE_RECOVERY_POLICY_DIGEST =
	"sha256:c7975b04efbe3f8078ab06f3c2408d1074255b7964be4c758e846d05331f9846" as const;
export const D753_BUDGET_LIMITS = D729_BUDGET_LIMITS;
export const D753_EFFECT_CEILINGS = D729_EFFECT_CEILINGS;
export const D753_ROUTE_PROFILE = D733_DEEPSEEK_V4_FLASH_0731_PROFILE;
export const D753_ROUTE_PROFILE_DIGEST = D733_DEEPSEEK_V4_FLASH_0731_PROFILE_DIGEST;

export const D753_COORDINATES = strictSnapshot({
	decisionRef: D753_DECISION_REF,
	decisionRevision: D753_DECISION_REVISION,
	generationRef: D753_GENERATION_REF,
	dispatchClaimRef: D753_DISPATCH_CLAIM_REF,
	...
	forwardPhaseContinuationPolicyDigest: D753_D737_PHASE_RECOVERY_POLICY_DIGEST,
	baselineCommit: D753_BASELINE_COMMIT,
	historicalQualificationDigest: D753_HISTORICAL_QUALIFICATION_DIGEST,
	previousFailureCode: "sanitized-transport-diagnostic-not-canonical",
	...
	budgetLimits: D753_BUDGET_LIMITS,
	effectCeilings: D753_EFFECT_CEILINGS,
	armOrder: [
		"cold",
		"relevant-applied",
		"proposal-only",
...
export const D753_COORDINATES_DIGEST = empiricalStrictJsonDigest(D753_COORDINATES);
