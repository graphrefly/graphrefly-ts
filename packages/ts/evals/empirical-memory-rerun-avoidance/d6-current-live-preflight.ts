...
export const CURRENT_GRAPH_LIVE_PRICING_OBSERVATION_SCHEMA =
	"graphrefly-ts.d6.current-graph-live-pricing-observation.v1" as const;
export const CURRENT_GRAPH_LIVE_ZERO_BYOK_SCHEMA =
	"graphrefly-ts.d6.current-graph-live-zero-byok-observation.v1" as const;
export const CURRENT_GRAPH_LIVE_PRECLAIM_SCHEMA =
	"graphrefly-ts.d6.current-graph-live-preclaim.v1" as const;
...
export function admitCurrentGraphLiveZeroByok(inputValue: {
	...
	if (
		...
		value.decisionRef !== "graphrefly-ts:D6" ||
