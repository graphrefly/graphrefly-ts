...
export const CURRENT_GRAPH_LIVE_DECISION_REF = "graphrefly-ts:D7" as const;
export const CURRENT_GRAPH_LIVE_DECISION_REVISION = "2026-08-15.v1" as const;
export const CURRENT_GRAPH_LIVE_BASELINE_COMMIT =
	"1568eec96211301522a381b326cb8dfecffe6bc4" as const;
...
export const CURRENT_GRAPH_LIVE_GENERATION_REF =
	"current-graph-native-live-2026-08-15-d7-v1" as const;
export const CURRENT_GRAPH_LIVE_DISPATCH_CLAIM_REF =
	"current-graph-native-live-dispatch-2026-08-15-d7-v1" as const;
...
export const CURRENT_GRAPH_LIVE_ROUTE = createCurrentGraphProviderRouteProfile({
	...
	// D7 consumes the frozen D6 provider-capable architecture for one live execution.
