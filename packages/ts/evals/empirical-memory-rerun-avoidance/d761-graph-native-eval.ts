...
} from "./d761-clean-graph-ledger.js";
import {
	...
	for (let runCount = 0; runCount < 12; runCount += 1) {
		...
		const runtime = createD722GraphEffectRuntime({
			...
			budgetContext: {
				...
				)?.revision === "graphrefly.b112.d761.public-semantic-validation-policy.v1"
					? { localEffectMaxElapsedMs: effectCeilings.localEffectMaxElapsedMs }
					: {}),
			},
			...(Object.hasOwn(input, "armLocalTerminalPolicy")
				? {
