...
import type { CurrentGraphLivePreclaimV1 } from "./d6-current-live-preflight.js";
import { consumeCurrentGraphLivePreclaim } from "./d6-current-live-preflight.js";
...
export const CURRENT_GRAPH_LIVE_DISPATCH_CLAIM_SCHEMA =
	"graphrefly-ts.d6.current-graph-live-dispatch-claim.v1" as const;
export const CURRENT_GRAPH_LIVE_EXECUTION_AUTHORITY_REVISION =
	"graphrefly-ts.d6.current-graph-live-execution-authority.v1" as const;
