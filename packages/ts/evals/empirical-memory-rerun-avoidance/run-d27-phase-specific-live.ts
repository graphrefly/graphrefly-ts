...
const zeroByokFile = join(privateEvidenceRoot, "d28-fresh-zero-byok-browser-attestation.v1.json");
...
const materializationRoot = await mkdtemp(join(tmpdir(), "graphrefly-d28-live-"));
