...
const zeroByokFile = join(privateEvidenceRoot, "d29-fresh-zero-byok-browser-attestation.v1.json");
...
const materializationRoot = await mkdtemp(join(tmpdir(), "graphrefly-d29-live-"));
