	...
	const topologyArtifact = Object.freeze({
		...
		caseResults: remapHistoricalCases(
			...
			new Set([
				...
				"d145DevelopmentUsd36AndTotalUsd42Caps",
				...
				"atomicProviderAdmissionObservationCut",
	...
	const liveArtifact = Object.freeze({
		...
		caseResults: remapHistoricalCases(
			...
			new Set([
				...
				"d150ClosedGrammarDiscriminantOnly",
				"d150SixArmCommonTaskStatement",
				"d150DistinctIncompatibleIrrelevantProvenance",
