...
import {
	type CurrentLiveCampaignCapabilityV1,
	consumeCurrentLiveCampaignCapability,
...
export function createD65LiveGraphCampaignAuthority(input: {
	readonly liveCampaignCapability: CurrentLiveCampaignCapabilityV1;
}): D65LiveGraphCampaignAuthorityV1 {
	const capability = consumeCurrentLiveCampaignCapability(input.liveCampaignCapability);
