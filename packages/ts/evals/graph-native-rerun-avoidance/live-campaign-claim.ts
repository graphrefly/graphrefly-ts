...
export const CURRENT_LIVE_CLAIM_SCHEMA = "graphrefly-ts.d68.live-campaign-claim.v1" as const;
export const CURRENT_LIVE_CLAIM_REF = "graph-native-live-claim-2026-08-22-d68-v1" as const;
export const CURRENT_LIVE_GENERATION_REF = "graph-native-live-2026-08-22-d68-v1" as const;
export const CURRENT_LIVE_PRIVATE_ROOT = resolve(
	import.meta.dirname,
	"../.private/graph-native-rerun-avoidance/current-live-d68",
);
...
export interface CurrentLiveDispatchClaimV1 {
	...
	readonly decisionRef: "graphrefly-ts:D68";
...
export async function acquireCurrentLiveDispatchClaim(input: {
	...
	const material = strictSnapshot({
		...
		decisionRef: "graphrefly-ts:D68" as const,
