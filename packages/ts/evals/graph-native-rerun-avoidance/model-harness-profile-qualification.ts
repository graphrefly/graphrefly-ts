...
export const MODEL_HARNESS_PROFILE_NO_NETWORK_QA_ARTIFACT = Object.freeze({
	schemaVersion: "graphrefly-ts.model-harness-profile-no-network-qa.v6" as const,
	...
	currentRouteDecisionRef: "graphrefly-ts:D158" as const,
	...
	currentProviderRef: "together" as const,
