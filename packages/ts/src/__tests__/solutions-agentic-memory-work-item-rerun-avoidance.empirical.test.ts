...
describe("B112.6.1 private empirical campaign qualification", () => {
	...
	it("keeps B112 empirical contracts private and outside runtime/build entries", () => {
		...
		for (const file of sourceFiles(EMPIRICAL_SOURCE_URL.pathname)) {
			...
			const allowsD699SingleUseDispatchOperator = file.endsWith(
				"d699-single-use-dispatch-claim.ts",
			);
			...
			const allowsD704MutationFirstLiveOperator = file.endsWith("d704-mutation-first-live.ts");
			...
			const allowsD729GraphNativeLive = file.endsWith("d729-graph-native-live.ts");
			...
			const allowsD736DispatchClaim = file.endsWith("d736-single-use-dispatch-claim.ts");
			...
			const allowsD748ForwardPhaseQualification =
				file.endsWith("d748-forward-phase-continuation-qualification.ts") ||
				file.endsWith("run-d748-no-network-pre-live.ts");
			const allowsD751TransportDiagnosticAuthority = file.endsWith(
				"d751-sanitized-transport-diagnostic.ts",
			);
			const allowsD751ImplementationManifest = file.endsWith("d751-implementation-manifest.ts");
			const allowsD751PrivateRunner = file.endsWith("run-d751-no-network-pre-live.ts");
			const allowsD751TransportDiagnosticQualification =
			...
			const allowsD753GraphNativeLive =
				file.endsWith("d753-graph-native-live.ts") ||
				file.endsWith("d753-single-use-dispatch-claim.ts");
			const allowsD753TransportDiagnosticAdapter = file.endsWith(
				"d753-transport-diagnostic-route-adapter.ts",
			);
			const allowsD753ImplementationManifest = file.endsWith("d753-implementation-manifest.ts");
			const allowsD753LiveQualification =
			...
			const allowsD758GraphNativeLive =
				file.endsWith("d758-graph-native-live.ts") ||
				file.endsWith("d758-single-use-dispatch-claim.ts");
			const allowsD758TransportDiagnosticAdapter = file.endsWith(
				"d758-transport-diagnostic-route-adapter.ts",
			);
			const allowsD758ImplementationManifest = file.endsWith("d758-implementation-manifest.ts");
			const allowsD758LiveQualification =
			...
			const allowsD773GraphNativeLive =
				file.endsWith("d773-coordinates.ts") ||
				file.endsWith("d773-graph-native-live.ts") ||
				file.endsWith("d773-implementation-manifest.ts") ||
				file.endsWith("d773-live-positive-gate.ts") ||
				file.endsWith("d773-live-route-authority.ts") ||
			...
			const allowsD775GraphNativeLive =
				file.endsWith("d775-coordinates.ts") ||
				file.endsWith("d775-graph-native-live.ts") ||
				file.endsWith("d775-implementation-manifest.ts") ||
				file.endsWith("d775-live-positive-gate.ts") ||
			...
			const allowsD777GraphNativeLive =
				file.endsWith("d777-coordinates.ts") ||
				file.endsWith("d777-graph-native-live.ts") ||
				file.endsWith("d777-implementation-manifest.ts") ||
				file.endsWith("d777-private-real-route-adapter.ts") ||
				file.endsWith("d777-single-use-dispatch-claim.ts") ||
				file.endsWith("run-d777-live.ts");
			const allowsD780GraphNativeLive =
				file.endsWith("d780-coordinates.ts") ||
				file.endsWith("d780-graph-native-live.ts") ||
				file.endsWith("d780-implementation-manifest.ts") ||
			...
			const allowsD782GraphNativeLive =
				file.endsWith("d782-coordinates.ts") ||
				file.endsWith("d782-graph-native-live.ts") ||
				file.endsWith("d782-implementation-manifest.ts") ||
				file.endsWith("d782-pre-live-qualification.ts") ||
			...
			const allowsCurrentGraphQualification =
				...
				file.endsWith("d35-retained-span-real-provider-qualification.ts") ||
				file.endsWith("d37-premature-final-qualification.ts");
			...
			const allowsD27LiveQualification =
				file.endsWith("/d27-phase-specific-live.ts") ||
			...
			const allowsCurrentGraphImplementationManifest =
				...
				file.endsWith("d35-retained-span-implementation-manifest.ts") ||
				file.endsWith("d37-premature-final-implementation-manifest.ts");
			...
			const allowsD35PrivateRunner = file.endsWith(
				"run-d35-retained-span-real-provider-no-network.ts",
			);
			const allowsD37PrivateRunner = file.endsWith("run-d37-premature-final-no-network.ts");
			const allowsCurrentGraphPrivateRunner =
				...
				allowsD37PrivateRunner ||
				allowsD35PrivateRunner;
			const allowsCurrentGraphLiveAdapter =
				...
				file.endsWith("d27-phase-specific-live.ts") ||
				file.endsWith("d35-retained-span-real-provider-composition.ts");
			...
			const allowsCurrentGraphLiveOperator =
				...
				file.endsWith("current-graph-native-live-claim.ts") ||
				file.endsWith("current-graph-native-live.ts") ||
				file.endsWith("current-graph-native-private-persistence.ts") ||
				...
				file.endsWith("d6-current-implementation-manifest.ts") ||
				file.endsWith("run-d6-current-no-network.ts") ||
				file.endsWith("d7-current-live-coordinates.ts") ||
				file.endsWith("d7-current-live-preflight.ts") ||
				file.endsWith("d7-current-live-claim.ts") ||
				file.endsWith("d7-current-live.ts") ||
				file.endsWith("d7-current-implementation-manifest.ts") ||
				file.endsWith("run-d7-live.ts") ||
				file.endsWith("d8-current-live-coordinates.ts") ||
				file.endsWith("d8-current-live-preflight.ts") ||
				file.endsWith("d8-current-live-claim.ts") ||
				file.endsWith("d8-current-live.ts") ||
				file.endsWith("d8-current-openrouter-adapter.ts") ||
				...
				file.endsWith("d12-current-live-coordinates.ts") ||
				file.endsWith("d12-current-live-claim.ts") ||
				file.endsWith("d12-current-live.ts") ||
				file.endsWith("d12-current-openrouter-adapter.ts") ||
				...
				file.endsWith("d15-current-live-coordinates.ts") ||
				file.endsWith("d15-current-live-claim.ts") ||
				file.endsWith("d15-current-live.ts") ||
				file.endsWith("d15-current-pre-live-qualification.ts") ||
				file.endsWith("d15-current-implementation-manifest.ts") ||
				file.endsWith("run-d15-current-no-network.ts") ||
				file.endsWith("run-d15-live.ts") ||
				file.endsWith("d16-current-live-coordinates.ts") ||
				file.endsWith("d16-current-live-claim.ts") ||
				file.endsWith("d16-current-live.ts") ||
			...
			const allowsD20CurrentGraphLive =
				...
				file.endsWith("d27-phase-specific-live-coordinates.ts") ||
				file.endsWith("d27-phase-specific-live-preflight.ts") ||
				file.endsWith("d27-phase-specific-live-claim.ts") ||
				file.endsWith("d27-phase-specific-live.ts") ||
				file.endsWith("d27-phase-specific-live-qualification.ts") ||
				file.endsWith("d27-phase-specific-live-implementation-manifest.ts") ||
				file.endsWith("run-d27-phase-specific-live-no-network.ts") ||
				...
				file.endsWith("d38-premature-final-live-coordinates.ts") ||
				file.endsWith("d38-premature-final-live-preflight.ts") ||
				file.endsWith("d38-premature-final-live-claim.ts") ||
				file.endsWith("d38-premature-final-real-provider-composition.ts") ||
				file.endsWith("d38-premature-final-live.ts") ||
				file.endsWith("d38-premature-final-live-qualification.ts") ||
				file.endsWith("d38-premature-final-live-implementation-manifest.ts") ||
				file.endsWith("run-d38-premature-final-live-no-network.ts") ||
				file.endsWith("run-d38-premature-final-live.ts") ||
				file.endsWith("d40-phase-specific-inference-authority.ts") ||
				file.endsWith("d40-phase-specific-inference-live-coordinates.ts") ||
				file.endsWith("d40-phase-specific-inference-live-preflight.ts") ||
				file.endsWith("d40-phase-specific-inference-live-claim.ts") ||
				file.endsWith("d40-phase-specific-real-provider-composition.ts") ||
				file.endsWith("d40-phase-specific-inference-live.ts") ||
				...
				file.endsWith("d42-phase-specific-inference-live-coordinates.ts") ||
				file.endsWith("d42-phase-specific-inference-live-preflight.ts") ||
				file.endsWith("d42-phase-specific-inference-live-claim.ts") ||
				file.endsWith("d42-phase-specific-inference-live.ts") ||
				file.endsWith("d42-phase-specific-inference-live-qualification.ts") ||
				file.endsWith("d42-phase-specific-inference-live-implementation-manifest.ts") ||
				file.endsWith("run-d42-phase-specific-inference-live-no-network.ts") ||
				file.endsWith("run-d42-phase-specific-inference-live.ts");
			...
			const allowsOneRequestFetchTransport =
				...
				allowsCurrentGraphLiveOneRequest ||
			...
			const allowsD27LiveRunner = file.endsWith("run-d27-phase-specific-live.ts");
				...
				allowsD690SealedOfflineOperator
					...
					: allowsD22RealProviderQualification ||
						...
						: allowsD703MutationFirstOperator ||
							...
							: allowsD27LiveRunner
								? /\b(?:WebSocket|setInterval|setImmediate|queueMicrotask)\b|node:(?:http|https|net|tls)|(?:from|import)\s+["'](?:http|https|net|tls|undici|ws)["']/
			...
			const invalidImports = imports.filter(
				(specifier) =>
					!(
						...
						(allowsCurrentGraphLiveOperatorWithD20 &&
							(specifier === "node:fs" || specifier === "node:os")) ||
						((allowsD35PrivateRunner || allowsD37PrivateRunner) && specifier === "node:os") ||
