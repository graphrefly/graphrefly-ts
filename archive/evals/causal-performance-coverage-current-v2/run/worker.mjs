...
`);
  const measure = (arm, mode) => measurementArm(config.identicalReference && arm === "candidate" ? "reference" : arm, mode);
...
`);
  ...
  for (let batch2 = 0; batch2 < RECIPE.orders.length; batch2++) {
    const arms = [...RECIPE.orders[batch2], ...row.group === "recovery" ? [] : ["plain"]];
