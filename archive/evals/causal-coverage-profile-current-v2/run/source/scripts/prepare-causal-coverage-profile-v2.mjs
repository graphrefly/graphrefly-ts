...
const b = await build({
	entryPoints: ["scripts/fixtures/causal-coverage-profile-v2.ts"],
	bundle: true,
	platform: "node",
	format: "esm",
	write: false,
...
for (const p of [
	...
	"scripts/prepare-causal-coverage-profile-v2.mjs",
	"pnpm-lock.yaml",
]) {
