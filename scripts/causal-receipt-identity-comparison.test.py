...
script=Path(__file__).with_name('verify-causal-receipt-identity-comparison.py');spec=importlib.util.spec_from_file_location('verify',script);v=importlib.util.module_from_spec(spec);spec.loader.exec_module(v)
