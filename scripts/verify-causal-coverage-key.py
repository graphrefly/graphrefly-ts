...
def verify(root):
 ...
 assert f['tool']==sha(root/'tool.mjs') and f['beforeSource']==sha(root/'evidence-before.ts')
 assert f['afterSource']==sha(root/'source/packages/ts/src/solutions/causal-occurrence/evidence.ts')
