---
title: "createSlidingWindowRateLimitTransitionInput()"
description: "Create and strictly normalize one sliding-window-v1 evaluator input."
---
...
| `policy` | `unknown` | Exact scoped sliding-window policy. |
