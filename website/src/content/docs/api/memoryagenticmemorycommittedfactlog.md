...
description: "Create an in-memory D589 reference fact-log adapter. This adapter is an executable reference for fact-log persistence semantics. It supplies committed fact read results only; library materialization remains a separate explicit DATA boundary. It does not provide production durability, application acknowledgement, live graph truth, hot hydration, or record mutation authority."
---
