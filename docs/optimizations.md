...
- **Store-mutation-events protocol (deferred post-1.0, co-landing with op-log changesets + worker-bridge wire-protocol Option B):**
  ...
  All three land together post-1.0 under one "snapshot delivery" session. No pre-1.0 action required.
