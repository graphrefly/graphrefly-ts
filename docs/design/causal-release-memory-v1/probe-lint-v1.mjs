...
const root = path.resolve(process.argv[2]),
	out = process.argv[3];
const record = (phase, n) => {
	const m = process.memoryUsage();
	appendFileSync(out, JSON.stringify({ phase, n, ...m }) + "\n");
