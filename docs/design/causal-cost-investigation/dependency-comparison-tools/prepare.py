...
import hashlib,json,os,pathlib,shutil,subprocess,tarfile,secrets
...
if __name__=='__main__':
 ...
 write(OUT/'order-bits.json',[secrets.randbits(1) for _ in range(24)])
 for f in ['build.mjs','child.mjs','driver.mjs','verify.py','collect.py','PLAN.md','prepare.py','continuity.py']:shutil.copyfile(HERE/f,tools/f)
